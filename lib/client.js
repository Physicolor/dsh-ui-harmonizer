window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		* flips on click; the active state uses the DeepSeek business blue. */
		...
		/** The "界面定制" block registered in Settings → General. */ function SettingsGeneralRow({ state, onApply, presets }) {
			return react.createElement("div", { style: {
				display: "flex",
				flexDirection: "column"
			} }, [
		...
		*/
		...
		function SettingsDialog({ title, subtitle, action, onClose, children }) {
			return react.createElement("div", {
